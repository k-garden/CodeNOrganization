Top.Controller.create('School_List_Popup_01_Logic', {
	/********************************* 초기화 영역 ************************************************/
	...
	init : function(event, widget){
		...
		CommonConfig.initialize(this, 'School_List_Popup_01');
		
		CommonEvent.onRenderTableView(this, 'School_List_Popup_01_TableView_School');
	...
	initResource : function(){
		...
		CommonConfig.initializeTableView('School_List_Popup_01_TableView_School');
	...
	getList : function(){
		...
		console.log(DTO);
		CommonTransfer.call(this, 'GetSchoolPopupService', DTO, 'School_List_Popup_01_TextView_Total_School', 'School_List_Popup_01_TableView_School');
	 ...
	 * @returns						: 
	 */
	returnSchoolData : function(){
		
		if(CommonClient.Dom.getSelectedIndexInTableView('School_List_Popup_01_TableView_School') == 0){
			CommonAction.Dialog.open("선택한 값이 없습니다.",false);
			return;
		}
		CommonAction.PopupParam.setCallBackDto(
				School_List_Popup_01_DR.School_List_Popup_01_DI[CommonClient.Dom.getSelectedIndexInTableView('School_List_Popup_01_TableView_School')]);
	...
	doCallBack : function(ret, xhr, callBackName) {
		...
		if (callBackName == 'GetSchoolPopupService') {
			console.log(ret);
			...
			CommonClient.Dom.setHintForTextField('School_List_Popup_01_TextField_Search_SCHOOL_SECTION_CODE_KOREAN_NAME', ret.dto.shoolDTO , 'SCHOOL_SECTION_CODE_KOREAN_NAME');
