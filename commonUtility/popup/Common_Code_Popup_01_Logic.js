Top.Controller.create('Common_Code_Popup_01_Logic', {
/********************************* 초기화 영역 ************************************************/
	...
	init : function(event, widget){
		...
		CommonConfig.initialize(this, 'Common_Code_Popup_01');
		
		CommonEvent.onRenderTableView(this, 'Common_Code_Popup_01_TableView_CommonCode');
	...
	initSelectBox : function(){
		CommonTransfer.callSelectBox(this, 'GetExtCodeService', {'MASTER_MAGIC_CONST' : '[학교구분]'});
	}, 
	...
	initResource : function(){
		...
		CommonConfig.initializeTableView('Common_Code_Popup_01_TableView_CommonCode');
	...
	getList : function(){
		...
		CommonTransfer.call(this, 'GetCodePopupService', DTO, 'Common_Code_Popup_01_TextView_Total_CommonCode', 'Common_Code_Popup_01_TableView_CommonCode');
		
	},
	
	/**
	 * @function 	 				: returnCodeData()
	 * @description					: 선택된 테이블뷰의 행 데이터 리턴함수
	 * 								: 
	 * @returns						: 
	 */
	returnCodeData : function(){
		
		if(CommonClient.Dom.getSelectedIndexInTableView('Common_Code_Popup_01_TableView_CommonCode') == 0){
	...
	doCallBack : function(ret, xhr, callBackName) {
		...
		if (callBackName == 'GetCodePopupService') {
			if(ret.dto.codePopupDTO == null)
				ret.dto.codePopupDTO = [];
			Common_Code_Popup_01_DR.Common_Code_Popup_01_DI = ret.dto.codePopupDTO;
			Common_Code_Popup_01_DR.update('Common_Code_Popup_01_DI');
			CommonClient.Dom.setHintForTextField('Common_Code_Popup_01_TextField_Search_CODE_DETAIL_KOREAN_NAME', ret.dto.shoolDTO , 'CODE_DETAIL_KOREAN_NAME');
